...
<i>if the proper condition holds, and program is run, and the program ends with the desired results, 
then the program is 'correct'</i>
- precondition: 'the proper condition'
- termination: 'the program stops'
- postcondition: 'the desired result'
- program's specification: the pre & postcondition pair
