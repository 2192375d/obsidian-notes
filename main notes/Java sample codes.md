...
- fields in an instance have default values, they are either forms of `0` or `null` for reference
- reference type behave like __pointers__, pointing to somewhere in __stack__, primitive type behave like __values__, stored in stack (reference itself as well)
- 